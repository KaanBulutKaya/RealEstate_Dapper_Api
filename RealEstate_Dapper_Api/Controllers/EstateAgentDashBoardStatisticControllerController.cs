...
namespace RealEstate_Dapper_Api.Controllers
{
    ...
    [ApiController]
    public class EstateAgentDashBoardStatisticControllerController : ControllerBase
    {
        private readonly IStatisticRepository _statisticRepository;

        public EstateAgentDashBoardStatisticControllerController(IStatisticRepository statisticRepository)
        {
